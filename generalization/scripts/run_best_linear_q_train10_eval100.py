...
"""Train the best linear-Q setup on 10 maps and validate on 100 held-out maps."""
...
def main() -> None:
    output_dir = os.path.join(PROJECT_ROOT, "results", "best_linear_q_train10_eval100")
    ...
    run_name = "best_linear_q_train10_eval100"
    ...
    training_figures = plot_training_curves(
        ...
        title="Best Linear-Q Training Curves (10 Training Maps)",
        subtitle="Best sweep configuration retrained on 10 maps before 100-map held-out validation",
        output_path=os.path.join(figures_dir, "training_curves_best_linear_q_train10.png"),
    )
    ...
    payload = {
        "experiment_name": "best_linear_q_train10_eval100",
        "generator_config": {
    ...
    output_path = os.path.join(output_dir, "best_linear_q_train10_eval100_summary.json")
