...
"""Train tabular Q-learning on a distribution of random instances and test generalization."""
...
from src.encoders import encode_absolute_state, encode_feature_state, encode_generalized_feature_state
...
def render_rollout_collection(
    *,
    ...
    for rollout in evaluation_summary.rollout_summaries:
        ...
        status_text = "Success" if rollout.success else "Failure"
...
def main() -> None:
    output_dir = os.path.join(PROJECT_ROOT, "results", "distributional_tabular_generalization")
    ...
    encoders: List[Tuple[str, object]] = [
        ...
        ("feature_v2", encode_generalized_feature_state),
    ]
    ...
    for encoder_name, encoder in encoders:
        ...
        training_figures = plot_training_curves(
            ...
            title=f"Distributional Training Curves ({encoder_name})",
            subtitle="Tabular Q-learning trained across a batch of random delivery instances",
        ...
        rollout_figures = plot_delivery_map(
            ...
            subtitle="Greedy policy rollout on a held-out random instance after distributional training",
    ...
    evaluation_figures = plot_evaluation_summary(
        evaluation_rows,
        title="Distributional Tabular Generalization Summary",
        subtitle="Generalization after training across multiple random delivery instances",
    ...
    output_path = os.path.join(output_dir, "distributional_summary.json")
