...
"""Evaluate an enhanced 3x3 local-window state design for tabular Q-learning."""
...
from src.encoders import encode_feature_state, encode_patch3x3_plus_state, encode_patch3x3_state, encode_path_distance_state
...
def main() -> None:
    output_dir = os.path.join(PROJECT_ROOT, "results", "patch3x3_plus_experiment")
    ...
    encoders: List[Tuple[str, object]] = [
        ...
        ("patch3x3_plus", encode_patch3x3_plus_state),
    ]
    ...
    for encoder_name, encoder in encoders:
        ...
        training_figures = plot_training_curves(
            ...
            subtitle="Comparing richer local-window state designs for tabular Q-learning",
        ...
        rollout_figures = plot_delivery_map(
            ...
            subtitle="Enhanced 3x3 local-window comparison on a held-out instance",
    ...
    evaluation_figures = plot_evaluation_summary(
        evaluation_rows,
        title="Enhanced 3x3 Local-Window Summary",
        subtitle="Adding navigation and topology context to the 3x3 observation state",
        output_path=os.path.join(figures_dir, "evaluation_summary.png"),
    )

    payload = {
        "experiment_name": "patch3x3_plus_experiment",
        "generator_config": {
    ...
    output_path = os.path.join(output_dir, "patch3x3_plus_summary.json")
